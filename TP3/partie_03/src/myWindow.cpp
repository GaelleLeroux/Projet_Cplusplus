  ...
  :QWidget(parent)
{
    ...
    QPushButton *button = new QPushButton("SelectAll", this);
    ...
    mainLayout->addWidget(button,16,3);
    ...
    connect(button ,SIGNAL(clicked()),this,SLOT(SAll()));
...
void myWindow::SAll()
{
    ...
    std::cout<<"Click on Select All ("<<checkBox1->isChecked()<<","<<checkBox2->isChecked()<<")"<<std::endl;
}
